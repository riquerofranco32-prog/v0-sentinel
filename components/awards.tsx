...
export function Awards() {
  ...
  return (
    <section
      ref={sectionRef}
      id="noticias"
      className="py-24 lg:py-32 bg-[#080c08]"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20">
          <h3
            className={`text-xl font-semibold text-white/80 mb-8 text-center transition-all duration-700 delay-100 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
          ...
          >
            {alliances.map((alliance, index) => (
              <div
                key={index}
                className="bg-[#0f1a0f] border border-white/10 rounded-xl p-4 hover:border-[#22c55e]/30 transition-all group flex flex-col items-center text-center"
              >
                <div className="w-12 h-12 bg-white/5 rounded-xl flex items-center justify-center mb-3 group-hover:bg-[#22c55e]/10 transition-colors">
                  <alliance.icon className="w-6 h-6 text-white/70 group-hover:text-[#22c55e] transition-colors" />
                </div>
        ...
        <div>
          <h3
            className={`text-3xl sm:text-4xl font-bold text-white mb-8 transition-all duration-700 delay-300 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
            style={{ fontFamily: "var(--font-heading)" }}
          >
          ...
          <div className="relative">
            <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide snap-x snap-mandatory">
              {awards.map((award, index) => (
                <div
                  key={index}
                  className={`group flex-shrink-0 w-72 bg-[#0f1a0f] border border-white/10 rounded-xl overflow-hidden hover:border-[#22c55e]/30 transition-all duration-700 snap-start ${
                    isVisible
            ...
            {/* Scroll Indicators */}
            <div className="absolute right-0 top-0 bottom-4 w-20 bg-gradient-to-l from-[#080c08] to-transparent pointer-events-none" />
          </div>
        </div>
        ...
        <div className="mt-16 grid md:grid-cols-2 gap-6">
          <div
            className={`relative rounded-2xl overflow-hidden aspect-video transition-all duration-700 delay-500 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
            <img
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/a.png-r7DZq5o2C7ZRgSFnWJFCJE9mEcYG0T.jpeg"
              alt="Equipo Sentinel en premiación"
              className="w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#080c08]/80 to-transparent" />
            <div className="absolute bottom-4 left-4">
              <span className="text-white/80 text-sm font-medium">Premiación ILAN-UTN & Sadosky</span>
            </div>
          </div>
          <div
          ...
          >
            <img
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/AGRADECIMIENTOS.png-PC41WLGETUGxSv88Lsddqo7QGl97so.jpeg"
              alt="Equipo Sentinel en eventos"
              className="w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#080c08]/80 to-transparent" />
            <div className="absolute bottom-4 left-4">
              <span className="text-white/80 text-sm font-medium">Prendete & Premios Sadosky</span>
            </div>
          </div>
        </div>
      </div>
